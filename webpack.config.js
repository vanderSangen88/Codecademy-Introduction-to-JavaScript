...
module.exports = {
    ...
    entry: {
        ...
        './excercises/1-Introduction/1-1-Introduction-to-JavaScript/1-1-6-Built-in-Methods/dist/bundle': './1-Introduction/1-1-Introduction-to-JavaScript/1-1-6-Built-in-Methods/src/app.js',
        './excercises/1-Introduction/1-1-Introduction-to-JavaScript/1-1-7-Libraries/dist/bundle': './1-Introduction/1-1-Introduction-to-JavaScript/1-1-7-Libraries/src/app.js'
    },
    output: {
